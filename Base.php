...
defined('VOTE_VIEW_HOME_PATH') or define('VOTE_VIEW_HOME_PATH',VOTE_DIR.'home'. DS . 'view');
defined('VOTE_VIEW_ADMIN_PATH') or define('VOTE_VIEW_ADMIN_PATH',VOTE_DIR.'admin'. DS . 'view');
